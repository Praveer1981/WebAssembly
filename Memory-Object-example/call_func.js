...
var wasmBinaryFile = 'call_func.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _print_value() {
  err('missing function: print_value'); abort(-1);
  }
...
var asmLibraryArg = { "abort": abort, "setTempRet0": setTempRet0, "getTempRet0": getTempRet0, "_print_value": _print_value, "tempDoublePtr": tempDoublePtr, "DYNAMICTOP_PTR": DYNAMICTOP_PTR }
// EMSCRIPTEN_START_ASM
var asm =Module["asm"]// EMSCRIPTEN_END_ASM
(asmGlobalArg, asmLibraryArg, buffer);

Module["asm"] = asm;
var _call_func = Module["_call_func"] = function() {  return Module["asm"]["_call_func"].apply(null, arguments) };
;
